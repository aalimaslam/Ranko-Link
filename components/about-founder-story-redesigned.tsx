...
export default function FounderSection() {
  ...
  return (
    <section
      className="relative overflow-hidden min-h-[780px] md:min-h-[820px] lg:min-h-[760px]"
      role="region"
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 py-20">
        {/* HEADER */}
        <div className="text-center mb-14">
          <motion.h2
            initial={{ opacity: 0, y: 6 }}
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.05 }}
            className="text-sm sm:text-base text-blue-200/80 max-w-2xl mx-auto mt-3"
          >
            The vision and mission behind RankoLink’s growth.
          </motion.p>
        </div>

        {/* ========= SINGLE COLUMN CONTENT (NO GRID) ========= */}
        <div className="space-y-10 mx-auto text-center">
          ...
          <motion.h3
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="text-3xl sm:text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#EAF2FF] via-[#BFE0FF] to-[#9CCBFF]"
            style={{
              textShadow:
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.05 }}
            className="text-blue-200/80 leading-relaxed text-base max-w-2xl mx-auto"
          >
            Adnan started as an independent SEO strategist, helping brands grow
            through premium link-building. His hands-on expertise and dedication
            helped shape RankoLink — now one of the most trusted authorities in
            SEO & backlinks.
          </motion.p>

          {/* Quote Box */}
          <div className="bg-white/6 border border-white/6 backdrop-blur-md rounded-xl p-5 shadow-sm max-w-2xl mx-auto">
            <div className="flex gap-4 items-start justify-center">
              ...
              <blockquote className="text-blue-100/90 font-medium leading-relaxed text-left max-w-xl">
                “If you're seeking transparent, reliable and results-driven SEO
                — you're at the right place. We focus on quality, ethics, and
          ...
          <motion.p
            ...
            className="text-blue-200/80 max-w-2xl mx-auto leading-relaxed"
          >
            Guided by his philosophy that{" "}
            <strong className="text-blue-100">
              “A client's success is our greatest achievement,”
            </strong>{" "}
            RankoLink continues delivering real ranking improvements worldwide.
          </motion.p>
        </div>
      </div>
    </section>
