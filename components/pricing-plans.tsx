        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative backdrop-blur-xl bg-blue-800/40 border border-blue-500 shadow-lg transition-all duration-500 hover:shadow-[0_0_40px_rgba(96,165,250,0.5)] hover:-translate-y-2 rounded-2xl ${
