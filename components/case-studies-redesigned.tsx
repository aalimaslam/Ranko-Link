...
export default function CaseStudiesRedesigned() {
  const caseStudies = [
    {
    ...
    <section id="case-studies" className="relative py-20 bg-gradient-to-b from-gray-50 via-white to-gray-100/50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* <div className="text-center space-y-4 mb-16">
          <h2 className="font-heading font-extrabold text-3xl lg:text-5xl text-gray-900">Case Studies</h2>
        ...
        <Heading black="Studies" colored="Case" description="Real results from real clients. See how our strategic link building campaigns have transformed businesses
            across different industries." />
              ...
              <Card className="border border-gray-200 bg-white shadow-md hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden transform hover:-translate-y-2 h-full">
                ...
                <CardHeader className="space-y-2">
                  <div className="flex items-center justify-between">
                    <CardTitle className="font-heading font-semibold text-xl text-gray-900">
                      {study.company}
                    </CardTitle>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors">
                      <div className="font-heading font-bold text-lg text-blue-600">
                        {study.results.backlinks}
                      </div>
